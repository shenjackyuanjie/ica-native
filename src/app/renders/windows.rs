            ...
            ctx.show_viewport_deferred(viewport_id, viewport_builder, move |ui, _class| {
                ...
                egui::CentralPanel::default().show_inside(ui, |ui| {
                    ...
                    if scroll_delta != 0.0 {
                        ...
                        state.zoom = (state.zoom * zoom_factor).clamp(0.05, 20.0);
                    }
                    ...
                    match ui.ctx().try_load_texture(
                        ...
                        Ok(egui::load::TexturePoll::Ready { texture }) => {
                            ...
                            let base_scale = base_scale_x.min(base_scale_y).min(1.0);
                            ...
                            let paint_pos = ui.min_rect().min + center_offset + pan_offset;
